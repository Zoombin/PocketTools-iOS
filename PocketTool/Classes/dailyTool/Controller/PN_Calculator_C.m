...
#import "PN_Calculator_Details.h"

@interface PN_Calculator_C ()
{
    NSMutableArray *_resultArray;
    NSString *_tempStr;
    PN_Calculator_Details *_calcultor;
...
@implementation PN_Calculator_C
...
- (void)viewDidLoad {
    ...
    _lastAnswer = @"";
    _calcultor = [[PN_Calculator_Details alloc]init];
